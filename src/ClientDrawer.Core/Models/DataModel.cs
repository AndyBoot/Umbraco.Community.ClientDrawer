...
using static ClientDrawer.Core.Models.DataModel.ChangeLogXml;
    ...
    public class DataModel
    {
        ...
        public class EnvironmentModel
        {
            public EnvironmentModel(string Name, Uri BaseUri, Uri CurrentUri, string UmbracoPathOrUrl, bool DisableUmbracoUrl, string[]? AlternativeHostNames, string IconClass)
            {
                ...
                UmbracoUrl = UmbracoPathOrUrl.InvariantStartsWith("http") ? UmbracoPathOrUrl : new UriBuilder(BaseUri.Scheme, BaseUri.Host, BaseUri.Port, UmbracoPathOrUrl).Uri.AbsoluteUri;
                this.Name = Name;
                PrimaryUrl = BaseUri.AbsoluteUri;
                IsCurrent = hostNames.InvariantContains(currentHostname);
                this.IconClass = IconClass;
                this.DisableUmbracoUrl = DisableUmbracoUrl || IsCurrent;
            }
